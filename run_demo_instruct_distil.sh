...
#     --infer-align-image-size \
#     --image ./assets/demo_instruct_imgs/input_0_0.png \
#     --save ./image_edit_0_image_distill.png \
#     --moe-impl flashinfer \
#     --diff-infer-steps 8 
...
#     --infer-align-image-size \
#     --image ./assets/demo_instruct_imgs/input_0_0.png \
#     --save ./image_edit_0_recaption_distill.png \
#     --moe-impl flashinfer \
#     --diff-infer-steps 8 
